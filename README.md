...
- services/
  - data_fetcher.go
  - technical_indicator_calculator.go
...
- store/
  ...
  - data_fetch_job_repository.go
  - stock_price_repository.go
  - technical_indicator_repository.go
  - fundamental_data_repository.go
  - news_event_repository.go
  - sentiment_data_repository.go
